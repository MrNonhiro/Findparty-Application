...
export default function notipage({ navigation }) {
    ...
    useEffect(() => {
        ...
        axios.get('http://34.124.194.224/noti_show_list_for_user.php', {
            params: {
                user_id: user_id
            }
        })
    ...
    return (
        <View style={styles.container}>
            <Header
                centerComponent={{ text: 'แจ้งเตือน', style: { color: 'black', fontSize: 25 } }}
                containerStyle={{
